...
// PolicyTypeSpec defines the desired state of PolicyType
type PolicyTypeSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of PolicyType. Edit policytype_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// PolicyTypeStatus defines the observed state of PolicyType
